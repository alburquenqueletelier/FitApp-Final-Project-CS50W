        ...
        case 'exercise':
            ...
            .then(menu => {
                ...
                menu.forEach(exercise => {
                    ...
                    `;
                    div_exercise.appendChild(div);
                })
            })
            break;
        case 'my_routine':
            const div_my_routine = document.querySelector('#div_my_routine');
            // Instrucciones para que el usuario pueda utilizar la app
            div_my_routine.innerHTML = `
...
function load_plan(data) {
    ...
    switch (data){
        case 'week':
            ...
            if(div_calendario.style.display == 'none')
                div_calendario.appendChild(table);
        ...
        case 'month':
            ...
            // })
            cal.innerHTML = '<h1>Esta herramienta aún esta en Desarrollo ! </h1>';
            div_calendario.appendChild(cal);
            div_calendario.style.display = 'block';
    }
}
